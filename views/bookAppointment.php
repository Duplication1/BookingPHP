    ...
    include 'components/aboutUs-header.html'?>
        <form class="container" action="bookAppointment.php" method="POST">
            ...
            <div class="row">
              ...
              <label for="description" class="appointment-description">Description</label>
              <textarea id="description" name="description" class="appointment-textarea" required></textarea>
